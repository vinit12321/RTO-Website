...
include 'Database_Connect.php';
 ...
 $rsid= $_REQUEST['id'];
	...
	$query1 = "SELECT * FROM plform WHERE Application_id = '" .$rsid ."'";
...
<div class="container">
  ...
  <div class="col-lg-4">
  <?php
  print	'<img src="data:image/png;base64,' . base64_encode($row['image3']) . '"  height="100px" width="100px"/> ';
  	?>
  </div>
  </<div>
  </div>
<table border="0px" style="border-color: white;" width="80%">
			...
			<tr>
         <?php   echo '<form name="LLform" class="form-inline" role="form" method="post" action="accept1.php?id='.$rsid.'"> ';  ?>
...
<td><input type="text" placeholder="PinCode" name="pincode"  class="form-control" value="<?php echo $row['llpincode'] ?>" disabled="disabled"/></td>
	...
	<?php  	 echo '<td colspan="2" > <a href="view1.php?id='.$rsid.'">View Document</a>' ?>
				</td>
			</tr>
		 ...
		 <td align="center">
           <label for=""> <?php echo $row['document2'] ?></label>
					...
					<?php  	 echo '<td colspan="2" > <a href="view2.php?id='.$rsid.'"> View Document </a>' ?>
				</td>
			</tr>
  ...
  Signature:
  <?php
  print	'<img src="data:image/png;base64,' . base64_encode($row['image4']) . '"  height="40px" width="100px"/> ';
  	?>
  </div>
</div>
  ...
  <div class="row">
      <div class="col-md-2">
			...
			<?php
			 echo ' <a href="accept.php?id='.$rsid.'">'?> <input type="submit" name="btnsub" value="Accept" class="btn btn-primary" onclick=""/></a>
   ...
   <div class="col-md-2">
     ...
     <?php   echo '<form name="LLform"  method="post" action="reject1.php?id='.$rsid.'"> '; ?>
			<?php
			 echo ' <a href="reject.php?id='.$rsid.'">'?> <input type="submit" name="btnsub" value="Reject" class="btn btn-primary" onclick=""/></a>
	</div>		 	    
