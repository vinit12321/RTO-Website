...
$rsid= $_REQUEST['RS_ID'];
	...
	$query1 = "SELECT * FROM RoadSignDetails WHERE MRSID = '" .$rsid ."'";
 ...
 <li class="sub-menu">
  ...
  <section id="main-content">
          <section class="wrapper site-min-height">
          	 ...
          	 <a href="RoadSign.php?" class="btn btn-info" role="button">Back</a>
          	<div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Road Signs
...
{
	$mrsname=$row1['MRSName'];
    $mrsimage=$row1['MRSImage'];

Print "<tr>";
Print '<td >'. $mrsname . "</td>";
Print '<td><img src="data:image/png;base64,' . base64_encode($row1['MRSImage']) . '" /></td>';
Print "</tr>";
}
?>
