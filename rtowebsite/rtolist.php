...
<html lang="en">
 ...
 <li class="sub-menu">
  ...
  <section id="main-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">RTO List
                   
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.html">Home</a>
                    </li>
                    <li class="active">RTO</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
<h1>List of rtos</h1> <br>

       <form name="find" method="post" action="#"/> 
  <h3> Select State:<select name="state" class="form" style="width:250px;height: 30px;">
 ...
 if($_SERVER['REQUEST_METHOD'] = "POST") 
    {
      ...
      $sta=$_POST['state'];
      $sql = "SELECT * FROM rtodetails where Stateid='$sta'";
...
while($row = mysql_fetch_array($retval, MYSQL_ASSOC))
{
 ...
 $bool=false;
echo " <tr><td>" .$row['RTOCode'].
" </td> <td>  ".$row['RTOName'].  " </td> <td>  ".$row['RTOAddress'].  "</td><td>".$row['RTOPhone']. "</td><td>".$row['RTOPinCode'] ." </td></tr>";
