...
$query1 = "SELECT * FROM RoadSignMaster";
...
{
	$rstype=$row1['RSType'];
    $rsimage=$row1['RSImage'];
    $rsid = $row1['RSID'];
Print "<tr>";
Print '<td >'. $rstype . "</td>";
Print '<td> <a href="RoadSignDetail.php?RS_ID='.$rsid.'"><img src="data:image/png;base64,' . base64_encode($row1['RSImage']) . '" /></a></td>';

//<td nowrap><a href="ind.php?page=processes">Processes</a></td>
Print "</tr>";
}
?>
