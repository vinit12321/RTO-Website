...
if(isset($_POST['btn-login']))
{
	...
	$res=mysql_query("SELECT * FROM UserDetails WHERE email='$email'");
 ...
 <li class="sub-menu">
  ...
  <section id="main-content">
	  ...
	  <!-- <div class="media-body">
	   ...
	   <h4 class="media-heading"> Login form </h4>
-->	  
<h2>Login form</h2>
  <form role="form" action="login.php" method="post" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pass" required="required">
    </div>
    <div class="checkbox">
