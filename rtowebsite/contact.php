  ...
  <section id="main-content">
        ...
        <div class="row">
             ...
             <div class="col-md-4">
                <h3>Thane Region</h3>
                <p>
                   Commissioner of Transport office,<br>Block-6, Second floor, Patil Bhavan,<br>Thane - 411010.
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 0222 - 23251367</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">mumrto@yahoo.in</a>
                </p>
             ...
             <div class="col-md-4">
                <h3>Mumbai Region</h3>
                <p>
                   Commissioner of Transport office,<br>Block-12, Third floor, S.V. Road ,<br>Andheri(West) - 401607.
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 0222 - 25612</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">E</abbr>: <a href="mailto:name@example.com">mumrto@yahoo.in</a>
                </p>
              ...
              <div class="col-md-4">
                <h3>Pune Region</h3>
                <p>
                   Commissioner of Transport office,<br>Kennedy Road, Shivaji Nagar,<br> 39, Sangamvadi, Pune 411001
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 0222 - 25612</p>
                <p><i class="fa fa-envelope-o"></i> 
