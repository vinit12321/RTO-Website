...
<?php
	...
	$rs=mysql_query("select t.test_name,t.total_que,r.test_date,r.score from mst_test t, mst_result r where t.test_id=r.test_id and test_name = 'RTO' and r.login = '$uname'", $cn) or die(mysql_error());
