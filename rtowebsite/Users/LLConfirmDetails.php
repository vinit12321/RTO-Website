...
if(isset($_POST['btnsub']))
{
 ...
 else
 {
    echo"Only images are allowed";
        ...
        $qur="Insert into llform (Userid,FirstName,MiddleName,LastName,Gender,Age,DOB,llcity,lltaluka,llstate,llpincode,image,vtype,document1,document2,image2,image3,image4,doc_id1,doc_id2,Status,Application_id) VALUES('$user','$fname','$mname','$lname','$gen','$age','$dob','$city','$taluka','$state','$pincode','$imagedata','$vehicletype','$dtype1','$dtype2','$imagedata1','$imagedata3','$imagedata4',$docn1,$docn2,'In Progress','".uniqid('MH',FALSE)."')";
