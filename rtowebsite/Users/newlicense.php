...
<td><input type="text" placeholder="PinCode" name="pincode"  class="form-control"  /></td>
    ...
    <option> Four Wheeler car </option>
		 ...
		 <option>Adhar Card</option>
				...
				<td><input type="text" style="border:none; " name="docnum1" required="required"/></td>
		 ...
		 <option>Adhar Card</option>
				...
				<td><input type="text" style="border:none;"  required="required" name="docnum2"/></td>
			...
			<div class="form-group">
				<td>
      <input type="file" accept="jpeg" size="20"  name="image3" class="form-control"  />
     
	  </td>
	  <td> OR <a href="Capture/index.php"> Click here to Capture</a> </td>
	  </tr>
	  <tr>
			<td>
			...
			<div class="form-group">
				<td>
      <input type="file" accept="jpeg" size="20" required="required" name="image4" class="form-control" />
	  </td>
	  </tr>
